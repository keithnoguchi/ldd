...
int main(void)
{
	const struct test *t, tests[] = {
		...
		{
			.name	= "0 byte SEEK_END on 16 bytes /dev/lseek16",
			.dev	= "lseek16",
			.alloc	= 16,
			.data	= "0123456789012345",
			.wsize	= 16,
		...
		{
			.name	= "-8 bytes SEEK_END on 16 bytes /dev/lseek16",
			.dev	= "lseek16",
			.alloc	= 16,
			.data	= "0123456789012345",
			.wsize	= 16,
		...
		{
			.name	= "-16 bytes SEEK_END on 16 bytes /dev/lseek16",
			.dev	= "lseek16",
			.alloc	= 16,
			.data	= "0123456789012345",
			.wsize	= 16,
		...
		{
			.name	= "0 byte SEEK_END on 8 bytes /dev/lseek16",
			.dev	= "lseek16",
			.alloc	= 16,
			.data	= "01234567",
			.wsize	= 8,
		...
		{
			.name	= "-8 bytes SEEK_END on 8 bytes /dev/lseek16",
			.dev	= "lseek16",
			.alloc	= 16,
			.data	= "01234567",
			.wsize	= 8,
		...
		{
			.name	= "0 byte SEEK_END on 64 bytes /dev/lseek64",
			.dev	= "lseek64",
			.alloc	= 64,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-32 bytes SEEK_END on 64 bytes /dev/lseek64",
			.dev	= "lseek64",
			.alloc	= 64,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-64 bytes SEEK_END on 64 bytes /dev/lseek64",
			.dev	= "lseek64",
			.alloc	= 64,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "0 byte SEEK_END on 32 bytes /dev/lseek64",
			.dev	= "lseek64",
			.alloc	= 64,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-32 bytes SEEK_END on 32 bytes /dev/lseek64",
			.dev	= "lseek64",
			.alloc	= 64,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "0 byte SEEK_END on 128 bytes /dev/lseek128",
			.dev	= "lseek128",
			.alloc	= 128,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-64 bytes SEEK_END on 128 bytes /dev/lseek128",
			.dev	= "lseek128",
			.alloc	= 128,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-128 bytes SEEK_END on 128 bytes /dev/lseek128",
			.dev	= "lseek128",
			.alloc	= 128,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "0 byte SEEK_END on 64 bytes /dev/lseek128",
			.dev	= "lseek128",
			.alloc	= 128,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-64 bytes SEEK_END on 64 bytes /dev/lseek128",
			.dev	= "lseek128",
			.alloc	= 128,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "0 byte SEEK_END on 256 bytes /dev/lseek256",
			.dev	= "lseek256",
			.alloc	= 256,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-128 bytes SEEK_END on 256 bytes /dev/lseek256",
			.dev	= "lseek256",
			.alloc	= 256,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-256 bytes SEEK_END on 256 bytes /dev/lseek256",
			.dev	= "lseek256",
			.alloc	= 256,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "0 byte SEEK_END on 128 bytes /dev/lseek256",
			.dev	= "lseek256",
			.alloc	= 256,
			.data	= "0123456789"
				"0123456789"
		...
		{
			.name	= "-128 bytes SEEK_END on 128 bytes /dev/lseek256",
			.dev	= "lseek256",
			.alloc	= 256,
			.data	= "0123456789"
				"0123456789"
